...
public class Events {
    ...
    //Classe qui gère les évenements

    public Events(){

    //Ici un evenement manifestation
    ...
    public void manifestation() {
        ...
        do {
            ...
            {
                case 1 :
                    //Ce case retire 100 d'argent et baisse la satisfaction des capitalistes de 15%
                    //mais ça peut être moins en fonction de Isle.difficulte qui est choisi par le joueur
    ...
    public void salaire () {
        ...
        //Cet evenement provoque un deuxième evenemnt juste après en fonction de la réponse selectionnée
